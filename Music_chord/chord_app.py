...
class ChordApp:
    def __init__(self, root):
        ...
        self.roman_numerals_text = tk.Text(root, height=40, width=20, font=self.font, wrap=tk.WORD)
        ...
        self.select_song_chords2_text = tk.Text(root, height=40, width=20, font=self.font, wrap=tk.WORD)
